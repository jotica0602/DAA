...
\includegraphics[width=0.8\textwidth]{../src/factibilidad_vs_n.png}
...
\includegraphics[width=0.8\textwidth]{../src/brecha_costo_vs_n.png}
...
\includegraphics[width=0.8\textwidth]{../src/tiempo_vs_n.png}

\subsection{Sensibilidad a densidad y restricciones (Experimento 3)}

Este experimento varía la probabilidad de aristas (\texttt{edge\_prob}) y violaciones de grado (\texttt{violation\_prob}) con $n$ fijo en 20. Los heatmaps muestran cómo estos parámetros afectan factibilidad y brecha. El primer heatmap ilustra la factibilidad: valores altos en densidad baja y restricciones altas reducen la factibilidad para todos los algoritmos, ya que hay menos opciones de conexión. Conclusión: En grafos esparcidos o con grados estrictos, los algoritmos luchan, sugiriendo preprocesamiento adicional.

\includegraphics[width=0.8\textwidth]{../src/heatmap_factibilidad.png}
...
\includegraphics[width=0.8\textwidth]{../src/heatmap_brecha.png}
...
\includegraphics[width=0.8\textwidth]{../src/robustez_semillas.png}
...
\includegraphics[width=0.8\textwidth]{../src/costo_mst_vs_factible.png}
...
\includegraphics[width=0.8\textwidth]{../src/conectividad_fallos.png}
